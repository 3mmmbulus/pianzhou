 ...
 * original location:
 *
 * <https://github.com/wwppcms/wwppcms-deprecated/blob/master/plugins/WwppcmsPluginApi2CompatPlugin.php>
 *
 ...
 * @version 2.1
 */
class WwppcmsPluginApi2CompatPlugin extends AbstractWwppcmsPluginApiCompatPlugin
{
    /**
    ...
    /**
     * Wwppcms's config array
     *
     * @see Wwppcms::$config
     * @see WwppcmsPluginApi2CompatPlugin::onConfigLoaded()
     *
     * @var array|null
     */
    protected $config;
    ...
    /**
     * Sets WwppcmsPluginApi1CompatPlugin::$config and handles the theme_url
     * config param
     *
     * @see WwppcmsPluginApi2CompatPlugin::$config
     *
     * @param array $config
     */
    public function onConfigLoaded(array &$config)
    {
        ...
        if (!empty($config['theme_url'])) {
            $config['themes_url'] = $this->getWwppcms()->getAbsoluteUrl($config['theme_url']);
