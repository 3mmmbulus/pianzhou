 ...
 * original location:
 *
 * <https://github.com/wwppcms/wwppcms-deprecated/blob/master/plugins/WwppcmsPluginApi1CompatPlugin.php>
 *
 ...
 * @version 2.1
 */
class WwppcmsPluginApi1CompatPlugin extends AbstractWwppcmsPluginApiCompatPlugin
{
    /**
     * This plugin extends {@see WwppcmsPluginApi2CompatPlugin} and
     * {@see WwppcmsThemeApi1CompatPlugin}
     *
     * @var string[]
     */
    protected $dependsOn = array('WwppcmsPluginApi2CompatPlugin', 'WwppcmsThemeApi1CompatPlugin');
    ...
    /**
     * Wwppcms's request file
     *
     * @see Wwppcms::$requestFile
     * @see WwppcmsPluginApi1CompatPlugin::onRequestFile()
     *
     * @var string|null
     */
    ...
    /**
     * Wwppcms's raw contents
     *
     * @see Wwppcms::$rawContent
     * @see WwppcmsPluginApi1CompatPlugin::onContentLoaded()
     *
     * @var string|null
     */
    ...
    /**
     * Wwppcms's meta headers array
     *
     * @see Wwppcms::$metaHeaders
     * @see WwppcmsPluginApi1CompatPlugin::onMetaHeaders()
     *
    ...
    /**
     * Wwppcms's pages array
     *
     * @see Wwppcms::$pages
     * @see WwppcmsPluginApi1CompatPlugin::onPagesLoaded()
     *
     * @var array[]|null
     */
    protected $pages;
    ...
    /**
     * Wwppcms's Twig instance
     *
     * @see Wwppcms::$twig
     * @see WwppcmsPluginApi1CompatPlugin::onTwigRegistered()
     *
     ...
     * reference and use {@see Wwppcms::loadPlugin()} to load additional plugins,
    ...
    public function onPluginsLoaded(array $plugins)
    {
        ...
        foreach ($plugins as $pluginName => $plugin) {
            if (!isset($originalPlugins[$pluginName])) {
                $this->getWwppcms()->loadPlugin($plugin);
            } elseif ($plugin !== $originalPlugins[$pluginName]) {
                throw new RuntimeException(
                    "A Wwppcms plugin using API version 1 tried to replace Wwppcms plugin '" . $pluginName . "' using the "
        ...
        if ($originalPlugins) {
            ...
            throw new RuntimeException(
                "A Wwppcms plugin using API version 1 tried to unload the Wwppcms plugin(s) '" . $removedPluginsList . "' "
    ...
    /**
     * Sets WwppcmsPluginApi1CompatPlugin::$requestFile
     *
     * @see WwppcmsPluginApi1CompatPlugin::$requestFile
     *
    ...
    /**
     * Sets WwppcmsPluginApi1CompatPlugin::$rawContent
     *
     * @see WwppcmsPluginApi1CompatPlugin::$rawContent
     *
    ...
    /**
     * Sets WwppcmsPluginApi1CompatPlugin::$pages
     *
     * @see WwppcmsPluginApi1CompatPlugin::$pages
     *
     ...
     * WwppcmsPluginApi1CompatPlugin::$metaHeaders
     *
     * @see WwppcmsPluginApi1CompatPlugin::$metaHeaders
     *
    ...
    /**
     * Sets WwppcmsPluginApi1CompatPlugin::$twig
     *
     * @see WwppcmsPluginApi1CompatPlugin::$twig
     *
     ...
     *
     * Wwppcms 1.0 and earlier were using the values of the meta headers array to
     ...
     * data. However, starting with Wwppcms 2.0 it is the other way round. This
    ...
    protected function getFlippedMetaHeaders()
    {
        if ($this->metaHeaders === null) {
            ...
            $this->getWwppcms()->getMetaHeaders();
        }
    ...
    /**
     * Syncs WwppcmsPluginApi1CompatPlugin::$metaHeaders with a flipped headers array
     *
    ...
    {
        return WwppcmsDeprecated::API_VERSION_2;
    }
    ...
    {
        return WwppcmsDeprecated::API_VERSION_1;
    }
}
